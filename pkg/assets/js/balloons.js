...
document.addEventListener("DOMContentLoaded", () => {
    class Balloon {
        constructor(options) {
            ...
            this.windEffect = 0;
            this.windChangeTime = 0;
            this.swayAngle = 0;
            this.windForce = 0;
            this.stringTension = 0.05;
            this.stringDamping = 0.9;
            this.stringAngle = 0;
        ...
        applyGravityAttraction(mouseX, mouseY, strength) {
            if (this.isDragging || this.isPopping)
                return;
    ...
    class BalloonManager {
        constructor() {
            ...
            this.globalWindForce = 0;
            this.globalWindTarget = 0;
            this.nextWindChange = 0;
            this.sizeSlider = document.getElementById('balloon-size');
            this.speedSlider = document.getElementById('balloon-speed');
            this.wobbleSlider = document.getElementById('balloon-wobble');
            this.stringLengthSlider = document.getElementById('string-length');
            this.addButton = document.getElementById('add-balloons');
            this.gravityStrengthSlider = document.getElementById('gravity-strength');
            this.gravityPointer = document.getElementById('gravity-pointer');
            this.gravityIndicator = document.getElementById('gravity-indicator');
            this.controlsToggle = document.getElementById('controls-toggle');
            this.controlsPanel = document.getElementById('balloon-controls');
        ...
        initExistingBalloons() {
            ...
            balloonElements.forEach((balloonElement, index) => {
                const element = balloonElement;
                const stringElement = stringElements[index];
