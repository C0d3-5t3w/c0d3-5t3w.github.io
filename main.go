...
func handler8(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("Serving balloons.php")
	data := map[string]string{"title": "Balloons"}
	renderTemplate(w, "balloons.php", data)
}
...
func handler9(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("Serving Znek.php")
	data := map[string]string{"title": "Znek"}
	renderTemplate(w, "Znek.php", data)
}
...
func handler10(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("Serving test.php")
	data := map[string]string{"title": "Test"}
	renderTemplate(w, "test.php", data)
...
func main() {
	...
	http.HandleFunc("/balloons.php", handler8)
	http.HandleFunc("/Znek.php", handler9)
	http.HandleFunc("/test.php", handler10)
